...
class MixedSamplesSample
 ...
 public:
  ...
  virtual void InitializeApplicationData(
    ...
    // Initialization for cube and torus rendering. Cube and torus shares the
    ...
    VkAttachmentDescription2KHR color_attachment_description2{
        VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR,  // sType
        nullptr,                                         // pNext
        0,                                               // flags
        render_format(),                                 // format
  ...
  virtual void InitializeFrameData(
    ...
    VkDescriptorImageInfo image_info = {
        ...
        *frame_data->depth_stencil_image_view_,           // imageView
        VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL  // imageLayout
    };
